...
var bold = {
    ...
    icon: 'fa fa-bold',
    i18n: 'bold',
    handler: function handler(editor, ev) {
...
__$styleInject(".vue-editor .color-card {\n  margin: 2px;\n  width: 30px;\n  height: 30px;\n  float: left;\n  cursor: pointer;\n}",undefined);
                ...
                Object.keys(config.upload.params).forEach(function (key) {
                    ...
                    if (Array.isArray(value)) {
                        value.forEach(function (v) {
                            formData.append(key, typeof v === 'function' ? v() : v);
                        });
                    } else {
...
var template$2 = "<form @submit.prevent=\"createLink\"> <input type=\"text\" :placeholder=\"$parent.locale['please enter a url']\" v-model=\"url\" maxlength=\"1024\"> <button type=\"submit\">{{$parent.locale[\"create link\"]}}</button> </form>";
...
var template$3 = "<form @submit.prevent=\"insertTable\"> <label> {{$parent.locale[\"row count\"]}}： <input type=\"number\" style=\"width: 60px\" maxlength=\"2\" min=\"2\" max=\"10\" v-model=\"rows\"> </label> <label> {{$parent.locale[\"column count\"]}}： <input type=\"number\" style=\"width: 60px\" maxlength=\"2\" min=\"2\" max=\"10\" v-model=\"cols\"> </label> <button type=\"submit\">{{$parent.locale.save}}</button> </form>";
...
__$styleInject("/**\n.vue-editor\n    ├──.toolbar\n    |    ├── ul  (menu)\n    |    └── .dashboard.html\n    └──.content\n*/\n\n.vue-editor {\n  font-size: 14px;\n  line-height: 1.5;\n  background-color: white;\n  color: #333;\n  border: 1px solid #ddd;\n  text-align: left;\n  border-radius: 5px;\n  overflow: hidden;\n  box-sizing: border-box\n\n}\n\n.vue-editor * {\n  box-sizing: border-box\n\n}\n\n.vue-editor.full-screen {\n  position: fixed !important;\n  top: 0 !important;\n  left: 0 !important;\n  bottom: 0 !important;\n  right: 0 !important;\n  border-radius: 0\n\n}\n\n.vue-editor > .toolbar {\n  position: relative;\n  background-color: inherit\n\n}\n\n.vue-editor > .toolbar > ul {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  border-bottom: 1px solid #ddd\n\n}\n\n.vue-editor > .toolbar > ul > li {\n  display: inline-block;\n  cursor: pointer;\n  text-align: center;\n  line-height: 36px;\n  padding: 0 10px\n\n}\n\n.vue-editor > .toolbar > ul > li .icon {\n  height: 16px;\n  width: 16px;\n  display: inline-block;\n  vertical-align: middle\n\n}\n\n.vue-editor > .toolbar > ul > li.active {\n  background: #FFF6D4;\n  color: #F6A623\n\n}\n\n.vue-editor > .toolbar > .dashboard {\n  background-color: inherit;\n  border-bottom: 1px solid #ddd;\n  padding: 10px;\n  //: absolute;\n  //: 100%;\n  //: 0;\n  //: 0;\n  overflow: auto;\n\n  & input, button, select {\n    line-height: normal\n\n  }\n\n}\n\n.vue-editor > .toolbar > .dashboard input[type='text'], .vue-editor > .toolbar > .dashboard input[type='number'], .vue-editor > .toolbar > .dashboard select {\n  padding: 6px 12px;\n  color: inherit;\n  background-color: transparent;\n  border: 1px solid #ddd;\n  border-radius: 5px\n\n}\n\n.vue-editor > .toolbar > .dashboard input[type='text']:hover, .vue-editor > .toolbar > .dashboard input[type='number']:hover, .vue-editor > .toolbar > .dashboard select:hover {\n  border-color: rgb(190, 190, 190)\n\n}\n\n.vue-editor > .toolbar > .dashboard input[type='text'][disabled], .vue-editor > .toolbar > .dashboard input[type='text'][readonly], .vue-editor > .toolbar > .dashboard input[type='number'][disabled], .vue-editor > .toolbar > .dashboard input[type='number'][readonly], .vue-editor > .toolbar > .dashboard select[disabled], .vue-editor > .toolbar > .dashboard select[readonly] {\n  background-color: #eee;\n  opacity: 1\n\n}\n\n.vue-editor > .toolbar > .dashboard input[type='text'][disabled], .vue-editor > .toolbar > .dashboard input[type='number'][disabled], .vue-editor > .toolbar > .dashboard select[disabled] {\n  cursor: not-allowed\n\n}\n\n.vue-editor > .toolbar > .dashboard button {\n  color: inherit;\n  background-color: inherit;\n  padding: 6px 12px;\n  white-space: nowrap;\n  vertical-align: middle;\n  cursor: pointer;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  border: 1px solid #ddd;\n  border-radius: 5px;\n  margin-right: 4px;\n  margin-bottom: 4px\n\n}\n\n.vue-editor > .toolbar > .dashboard button:hover {\n  border-color: rgb(190, 190, 190)\n\n}\n\n.vue-editor > .toolbar > .dashboard button[disabled] {\n  cursor: not-allowed;\n  opacity: .68\n\n}\n\n.vue-editor > .toolbar > .dashboard button:last-child {\n  margin-right: 0\n\n}\n\n.vue-editor > .toolbar > .dashboard label {\n  font-weight: bolder\n\n}\n\n.vue-editor > .content {\n  overflow: auto;\n  padding: 10px\n\n}\n\n.vue-editor > .content:focus {\n  outline: 0\n\n}\n\n@media (max-width: 767px) {\n  .vue-editor {\n    .dashboard {\n      label, input[type='text'], input[type='number'], button, select {\n        display: block;\n        margin-bottom: 5px;\n        width: 100% !important\n      }\n      label:last-child, input[type='text']:last-child, input[type='number']:last-child, button:last-child, select:last-child {\n        margin-bottom: 0\n\n      }\n    }\n  }\n}\n\n@media (min-width: 768px) {\n  .vue-editor {\n    .dashboard {\n      label, input, button, select {\n        display: inline-block;\n        margin-right: 4px;\n        max-width: 100%\n      }\n      label:last-child, input:last-child, button:last-child, select:last-child {\n        margin-right: 0\n\n      }\n    }\n  }\n}",undefined);

var template$4 = "<div class=\"vue-editor\" :class=\"{'full-screen':fullScreen}\" :style=\"{'z-index':zindex}\"> <div class=\"toolbar\" :style=\"{'z-index':zindex+1}\" ref=\"toolbar\"> <ul> <template v-for=\"module in modules\"> <li :name=\"module.name\" :title=\"locale[module.i18n]\" v-if=\"module.title\"> <div v-if=\"module.selects\"> {{module.title}}： <select @change=\"activeModule(module, $event)\"> <option :value=\"num\" v-for=\"num in module.selects\">{{num}}</option> </select> </div> <div v-else @click=\"activeModule(module, $event)\">预览</div> </li> <li :class=\"{align: module.class === 'align', list: module.class === 'list', active: modulesClass[module.name]}\" :name=\"module.name\" :title=\"locale[module.i18n]\" :data-type=\"module.type\" @click=\"activeModule(module, $event)\" v-else> <span class=\"icon\" :class=\"module.icon\"></span> <template v-if=\"showModuleName === undefined ? defaultShowModuleName : showModuleName\"> &nbsp;{{locale[module.i18n]}} </template> </li> </template> <div v-show=\"showErrLog\" style=\"color: #f00;padding-left: 10px\">{{showErrLog}}</div> </ul> <div class=\"dashboard\" v-show=\"dashboard\" ref=\"dashboard\"> <keep-alive> <div v-show=\"dashboard\" :is=\"dashboard\"></div> </keep-alive> </div> </div> <div class=\"content\" ref=\"content\" :style=\"contentStyle\" contenteditable></div> </div>";

var highlightedDom = function (node, editor) {
...
var editor = {
    ...
    watch: {
        ...
        showErrorLog: function showErrorLog(val){
            this.showErrLog = val;
        },
    ...
    methods: {
        ...
        toggleButtonClass: function toggleButtonClass(arg){
            var this$1 = this;

            if (!arg.target) { return }
            var dom = arg.target && arg.target.nodeName === 'SPAN' ? arg.target.parentNode : arg.target;
            ...
            if (!this.modulesClass[type]) {
                var arr = domObject[type] || [];
                for (var i = arr.length - 1; i >= 0; i--) {
                    this$1.modulesClass[arr[i]] = false;
                }
            }
            this.modulesClass[name] = !this.modulesClass[name];
        },
        execCommand: function execCommand(command, ev){
        ...
        forNode: function forNode(start, end){
            var this$1 = this;
            ...
            if (start.nodeName === end.nodeName) {
                ...
                for (var i = nodes.length - 1; i >= 0; i--) {
                    ...
                    highlightedDom(start, this$1);
                    // console.log(start.nodeName)
                    this$1.forNode(nodes[i].nodeName, end);
                }
            }
        },
        ...
        activeModule: function activeModule(module, ev){
 ...
 */
var VueEditor = function VueEditor(options) {
 ...
 * @param options
 */
VueEditor.install = function install (Vue, options) {
        if ( options === void 0 ) options = {};

    Vue.component(options.name || 'vue-editor', new VueEditor(options));
};
